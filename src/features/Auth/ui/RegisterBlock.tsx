...
interface IRegisterBlockProps {
   onClick: (data: IRegisterBody) => void;
   setHaveAccount: () => void
}
...
export const RegisterBlock = ({ onClick, setHaveAccount }: IRegisterBlockProps) => {
   ...
   return (
      ...
      >
         ...
         <div className="text-right">
            ...
            <button onClick={setHaveAccount} className="underline">Войти</button>
         </div>
      </form>
   );
};
